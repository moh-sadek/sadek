...
export default {
    ...
    methods: {
        ...
        getUser(pageNo) {
            ...
            this.$blockUI.Start();
            this.$http.getRequest(this.pageNo, this.pageSize)//this.$parent.SuperPackageParent.superPackageId
                .then(response => {
                    this.$blockUI.Stop();
        ...
        ActivateUser(UserId) {
            ...
            this.$confirm('سيؤدي ذلك إلى تفعيل حساب الدكتور  . استمر؟', 'تـحذير', {
                confirmButtonText: 'نـعم',
                cancelButtonText: 'لا',
                type: 'warning'
            }).then(() => {
                ...
                this.$http.ConfirmRequest(UserId)
                    .then(response => {
                        if (this.users.lenght === 1) {
                            this.pageNo--;
                            if (this.pageNo <= 0) {
                        ...
                        this.$message({
                            type: 'info',
                            message: 'تم تفعيل حساب الدكتور بنجاح',
                        });
                        this.getUser();
                    })
                    .catch((err) => {
